...
public class PoRecon {
	...
	public String toString() {
		return "PoRecon [poDocNo=" + poDocNo + ", poItemNo=" + poItemNo
				...
				+ ", invoiceNo=" + invoiceNo + ", invoiceQty=" + invoiceQty
				+ ", supplierInvNo=" + supplierInvNo + ", balanceQty="
				+ balanceQty + ", rejectionQty=" + rejectionQty + ", reason="
